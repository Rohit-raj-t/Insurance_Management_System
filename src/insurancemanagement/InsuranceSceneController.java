    ...
    private boolean GetInsuranceFields() {
       inNum = iNum.getText();
        ...
        if(inNum==null || inNum.isEmpty()){
            iNum.requestFocus();
            warnMsg.setText("Pls enter Insurtance Number");
            return false;
        }
        
        if(clName==null || clName.isEmpty()){
           cName.requestFocus();
            warnMsg.setText("Pls enter Insurance Name.");
            return false;
        }
        
        if(inType==null || inType.isEmpty()){
            
            warnMsg.setText("Pls Give Insurance Type.");
            return false;
        }
        ...
        if(inPayM==null || inPayM.isEmpty()){
            ...
            warnMsg.setText("Pls enter Pay Per Month.");
            return false;
        }
        if(bCode==null || bCode.isEmpty()){
            
            warnMsg.setText("Pls Select a Branch.");
            return false;
        }
        if(eName==null || eName.isEmpty()){
            
            warnMsg.setText("Pls Select an Employee.");
            return false;
        }
